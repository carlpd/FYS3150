...
$$
I tillegg er $u$ enhetsløs så vi setter $x$ og $y$ til å gå fra $0$ til $1$. Selve likningens tilstand vil bli videre diskutert i \autoref{ssec:Init}. $v(x,y)$ er også innenfor det samme enhetsløse to-dimensjonale planet og vil også bli videre diskutert i \autoref{ssec:Spalte}.
