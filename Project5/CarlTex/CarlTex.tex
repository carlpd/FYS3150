...
$$
i\frac{\delta u}{\delta t}=-\frac{\delta^2 u}{\delta^2 x}-\frac{\delta^2 u}{\delta^2 y}+v(x,y)
$$
Av Crank-Nicolson har vi at
$$
\frac{u^{n+1}_i-u^{n}_i}{\delta t}=\frac{1}{2}(\frac{u_{i+1}^{n+1}+}{(\delta x)^2})
$$
\section{Metode}
\section{Resultater}
\section{Diskusjon}
