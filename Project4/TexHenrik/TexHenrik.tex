...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{../Images/meanepsT1.0L20.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{../Images/meanmT1.0L20.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{../Images/meanepsT2.4L20.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{../Images/meanmT2.4L20.pdf}
...
Vi vet at forventingsverdien for energien per spinn skal være $\left < \epsilon \right > = -2 \; J\kB$ ved , som vi har funnet analytisk. Det stemmer godt overens med de numeriske resultatene som vi ser i \autoref{Fig:5e1} og \autoref{Fig:5e24} hvor vi den tilfeldige initialstilstanden møter tilstanden med alle spinn opp ved å flate ut ved $\left < \epsilon \right > 'approx -2 \; J\kB$. Ved å se på grafene så velger vi burn-in tiden som 1000 Monte Carlo sykluser. 
