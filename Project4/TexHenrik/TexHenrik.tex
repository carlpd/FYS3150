...
For $T = 1.0 \; J/k_B$ og $L = 20$, så fikk vi sannsynligehtsfordelingen som vist i \autoref{Fig:Den1}. 

\begin{figure}[H]
\centering
\includegraphics[scale=0.5, trim 2.5cm 0 0 0]{../Images/T100L20.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4, trim=1.7cm 0 0 0 ]{../Images/meanmT1L20.pdf}
