...
For temperatur $T= 1 \; J/k_B$ så fikk vi at  
...
\caption{Forventingsverdien til magnetisering per spinn. Her er temperaturen $T=2.4 \; J/k_B$.}
\label{Fig:5m1}
\end{figure}
...
\caption{Forventingsverdien av energien per spinn etter et antall Monte Carlo sykluser.}
\label{Fig:5e24}
\end{figure}
...
\caption{Forventingsverdien til magentisering per spinn. Her er $T=2,4 \; J/k_B$.}
\label{Fig:5m24}
\end{figure}
